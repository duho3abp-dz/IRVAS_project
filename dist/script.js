...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var formsData = {
    path: '/request',
    forms: ['form'],
    onlyNumbersInputClass: ['.form_input-user_phone', '.popup_calc .form-control'],
    formStateElemClass: {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])(modalData);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(tabsData);
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_2__["default"])(formsData);
...
var backgroundCloseModal = function backgroundCloseModal(_ref) {
  var modal = _ref.modal,
      _ref$clickBg = _ref.clickBg,
      clickBg = _ref$clickBg === void 0 ? true : _ref$clickBg;
...
var changeFormState = function changeFormState(_ref) {
  var formState = _ref.formState,
      windowFormsClass = _ref.windowFormsClass,
      windowWidthId = _ref.windowWidthId,
      windowHeightId = _ref.windowHeightId,
      windowCheckboxClass = _ref.windowCheckboxClass,
      windowViewTypeId = _ref.windowViewTypeId,
      _ref$defaultNumForm = _ref.defaultNumForm,
      defaultNumForm = _ref$defaultNumForm === void 0 ? 0 : _ref$defaultNumForm;
  var windowForm = document.querySelectorAll(windowFormsClass),
  ...
  var bindActionToElems = function bindActionToElems(elem, e, prop) {
    var targetProp = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'value';

    for (var _len = arguments.length, add = new Array(_len > 4 ? _len - 4 : 0), _key = 4; _key < _len; _key++) {
      add[_key - 4] = arguments[_key];
    }

    return elem.forEach(function (el) {
      el.addEventListener(e, function (_ref2) {
        var target = _ref2.target;
...
/***/ "./src/js/modules/checkingInputsOnData.js":
/*!************************************************!*\
  !*** ./src/js/modules/checkingInputsOnData.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (checkingInputsOnData);

/***/ }),

/***/ "./src/js/modules/error.js":
/*!*********************************!*\
  !*** ./src/js/modules/error.js ***!
  \*********************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/modules/es.object.from-entries */ "./node_modules/core-js/modules/es.object.from-entries.js");
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _services_servise__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../services/servise */ "./src/js/services/servise.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modal */ "./src/js/modules/modal.js");
/* harmony import */ var _spinner__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./spinner */ "./src/js/modules/spinner.js");
/* harmony import */ var _success__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./success */ "./src/js/modules/success.js");
/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./error */ "./src/js/modules/error.js");
/* harmony import */ var _toggleCheckbox__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./toggleCheckbox */ "./src/js/modules/toggleCheckbox.js");
/* harmony import */ var _onlyNumbersInput__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./onlyNumbersInput */ "./src/js/modules/onlyNumbersInput.js");
/* harmony import */ var _changeFormState__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./changeFormState */ "./src/js/modules/changeFormState.js");
...
var form = function form(_ref) {
  var path = _ref.path,
      ...
      messageClosingTime = _ref.messageClosingTime,
      formStateElemClass = _ref.formStateElemClass;
  var formState = {};
  Object(_changeFormState__WEBPACK_IMPORTED_MODULE_20__["default"])(_objectSpread(_objectSpread({}, formStateElemClass), {}, {
    formState: formState
  }));
  Object(_toggleCheckbox__WEBPACK_IMPORTED_MODULE_18__["default"])({
    checkboxClass: ['.checkbox']
  });
  onlyNumbersInputClass.forEach(function (inputClass) {
    return Object(_onlyNumbersInput__WEBPACK_IMPORTED_MODULE_19__["default"])({
  ...
  forms.forEach(function (form) {
    ...
    allForms.forEach(function (form) {
      return form.addEventListener('submit', function (e) {
        e.preventDefault();
        document.body.append(_spinner__WEBPACK_IMPORTED_MODULE_15__["default"]);
        _spinner__WEBPACK_IMPORTED_MODULE_15__["default"].style.display = '';
        ...
        Object(_services_servise__WEBPACK_IMPORTED_MODULE_13__["default"])(data, path).then(function (res) {
          return responseProcessing(_success__WEBPACK_IMPORTED_MODULE_16__["default"]);
        }).catch(function (err) {
          return responseProcessing(_error__WEBPACK_IMPORTED_MODULE_17__["default"]);
        }).finally(function () {
          _spinner__WEBPACK_IMPORTED_MODULE_15__["default"].style.display = 'none';
          form.reset();
...
/* harmony import */ var _checkingInputsOnData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkingInputsOnData */ "./src/js/modules/checkingInputsOnData.js");
...
var modal = function modal(_ref) {
  ...
  var closingAllModals = function closingAllModals() {
    return modalWindows.forEach(function (modalClass) {
  ...
  buttons.forEach(function (item, i) {
    ...
    var clickBg = true;
    notCloseClickBgClass.forEach(function (item) {
      if (item === modalWindows[i]) {
        clickBg = false;
      }
    });
    btns.forEach(function (btn) {
      return btn.addEventListener('click', function (e) {
        ...
        if (Object(_checkingInputsOnData__WEBPACK_IMPORTED_MODULE_3__["default"])(e.target, inputOrCheckboxNotSwitchData)) {
          return;
        }
...
/***/ "./src/js/modules/onlyNumbersInput.js":
/*!********************************************!*\
  !*** ./src/js/modules/onlyNumbersInput.js ***!
  \********************************************/
/*! exports provided: default */
...
var onlyNumbersInput = function onlyNumbersInput(_ref) {
...
/* harmony import */ var _backgroundCloseModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./backgroundCloseModal */ "./src/js/modules/backgroundCloseModal.js");
...
var picture = function picture(_ref) {
  ...
  imgClass.forEach(function (img) {
    ...
    Object(_backgroundCloseModal__WEBPACK_IMPORTED_MODULE_3__["default"])({
      modal: popup
    });
  });
};
...
/***/ "./src/js/modules/toggleCheckbox.js":
/*!******************************************!*\
  !*** ./src/js/modules/toggleCheckbox.js ***!
  \******************************************/
/*! exports provided: default */
...
var toggleCheckbox = function toggleCheckbox(_ref) {
  var checkboxClass = _ref.checkboxClass;
  checkboxClass.forEach(function (item, i) {
    var allCheckbox = document.querySelectorAll(checkboxClass[i]);
    allCheckbox.forEach(function (chackBox) {
      return chackBox.addEventListener('click', function (_ref2) {
        var target = _ref2.target;
        allCheckbox.forEach(function (chackBox) {
          return chackBox.checked = false;
        });
        target.checked = true;
      });
    });
...
/* harmony default export */ __webpack_exports__["default"] = (toggleCheckbox);

/***/ }),

/***/ "./src/js/services/servise.js":
/*!************************************!*\
  !*** ./src/js/services/servise.js ***!
  \************************************/
/*! exports provided: default */
...
var postData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form, path) {
    var _url, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetch("".concat(_url).concat(path), {
              method: 'POST',
              headers: {
          ...
          case 3:
            ...
            throw new Error("Server: ".concat(_url, ", path: ").concat(path, ", error status: ").concat(data.status));
